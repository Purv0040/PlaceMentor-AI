    ...
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-md p-6 sm:p-8 rounded-2xl bg-[#121624] border border-[#232b3e] shadow-2xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">Access your AI Placement Copilot & Telemetry Dashboard</p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] uppercase font-mono text-slate-500">or email</span>
          <div className="flex-1 h-[1px] bg-[#232b3e]" />
        </div>
          ...
          <div className="flex items-center justify-between text-xs">
            <label className="flex items-center gap-2 text-slate-400 cursor-pointer select-none">
              <input
                ...
                className="w-4 h-4 rounded border-[#232b3e] bg-[#0b0e17] text-indigo-500 focus:ring-0"
              />
              <span>Remember me</span>
            </label>

            <NavLink to="/forgot-password" className="text-indigo-400 hover:underline font-medium">
              Forgot password?
            </NavLink>
          </div>
        ...
        <div className="text-center text-xs text-slate-400">
          ...
          <NavLink to="/signup" className="text-indigo-400 font-bold hover:underline">
            Sign up
          </NavLink>
        </div>
      </div>
